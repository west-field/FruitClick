...
{
	defaultMapTable_[InputType::slect] = { {InputCategory::keybd,KEY_INPUT_RETURN},
	...
	//入力タイプの名前テーブルを作る
	inputNameTable_[InputType::slect] = L"選択";
...
InputState::Update()
{
	...
	//keymap.firstには、対応するゲーム入力名の"InputType::slect"などが入っている
